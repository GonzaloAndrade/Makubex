...
ALLOWED_HOSTS = ['gonzalo-andrade.com', '127.0.0.1']
...
ROOT_URLCONF = 'Makubex.urls'

WSGI_APPLICATION = 'Makubex.wsgi.application'
...
STATIC_ROOT = '/home1/rawrkyco/public_html/makubex/static'
STATIC_URL = '/static/'